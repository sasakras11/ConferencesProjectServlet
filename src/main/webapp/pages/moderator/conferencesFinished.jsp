                        ...
                        <table class="table" cellspacing="0">
                            ...
                            <c:forEach var="conference" items="${requestScope.conferences}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="/?type=finished&conferenceId=<c:out value='${conference.conferenceId}&command=ShowSpeeches'/>"><fmt:message
...
<div class="text-center fixed-bottom" style="margin-bottom: 220px">
    <form action="/?command=FindPage" method="post">
        <div class="form-group">
            ...
            <input type="text" id="pageFinished" name="pageFinished">
        </div>
